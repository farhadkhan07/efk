...
```
## Fluent Bit: setup log forwarder allowing you to send Kubernetes logs:
```
...
## Now Deploy the fluent-bit daemonset to start forwarding logs: 
  ...
  template:
    ...
    spec:
      ...
      - operator: "Exists"
        effect: "NoSchedule"
```
## Setup Fluent Bit with Elasticsearch Authentication enabled in Kubernetes

## Create secret for fluent-bit
```
...
apiVersion: v1
data:
  password: T0w4dFdBM2VUdTdCN0Y5TkZsamE=
kind: Secret
metadata:
